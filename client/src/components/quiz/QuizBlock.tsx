...
export function QuizBlock({ quiz, questionLabel = "checkpoint / quiz", onComplete }: Props) {
                ...
                return (
                  ...
                  >
                    <div className="flex items-start gap-3 mb-4">
                      <span className="text-xs font-mono uppercase tracking-widest text-stone-500 tabular-nums shrink-0 pt-0.5">
