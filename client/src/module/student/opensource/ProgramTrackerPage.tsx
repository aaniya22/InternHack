...
const PROGRAMS: Program[] = [
  ...
  },
  {
    ...
    short: "SoB",
    description: "Paid global summer internship in Bitcoin and Lightning free software. Applicants clear a screening exam, then propose a project to a mentoring organization.",
    fullDescription: "Summer of Bitcoin is an online summer internship that introduces university students to Bitcoin open source development. Students take a screening exam on Bitcoin fundamentals and programming, complete a bootcamp, and then work for roughly twelve weeks with mentors from organizations such as Bitcoin Core, Lightning Labs, Core Lightning, and BTCPay Server.",
    eligibility: "University students 18+, undergraduate or postgraduate",
    eligibilityType: "Students",
    stipend: "$3,000+ (varies by edition)",
    stipendPaid: true,
    stipendRange: "Medium",
    window: "Jan – Mar (applications)",
    status: "Annual",
    ...
    applyUrl: "https://www.summerofbitcoin.org",
    color: "text-stone-700",
    bgColor: "bg-stone-50 border-stone-200",
    tags: ["bitcoin", "lightning", "paid", "cpp", "rust"],
    requirements: [
      "Enrolled university student, 18 or older when applying",
      "Pass the screening exam on Bitcoin and programming basics",
      "Working knowledge of C++, Rust, Go, or TypeScript",
      "Ability to build a node implementation from source and run its tests",
      "Comfort with mailing lists, IRC, and review-heavy workflows",
      "Full-time availability during the summer coding period",
    ],
    timeline: [
      { phase: "Applications Open", dates: "January" },
      { phase: "Screening Exam", dates: "February" },
      { phase: "Bootcamp & Proposal Writing", dates: "Mar – Apr" },
      { phase: "Results Announced", dates: "May" },
      { phase: "Coding Period", dates: "Jun – Aug (12 weeks)" },
      { phase: "Final Evaluations", dates: "August" },
    ],
    howToApply: [
      "Register on summerofbitcoin.org when applications open",
      "Study Bitcoin fundamentals and clear the screening exam",
      "Build a node implementation from source and run the test suite",
      "Join a mentoring org's IRC or Discord and pick up a first issue",
      "Write a proposal with weekly milestones for the coding period",
      "Submit before the portal closes and stay responsive to mentors",
    ],
    applicationDeadline: nextDate(2, 28),
    difficulty: "Advanced",
    focusArea: "DEVELOPMENT",
  },
  {
    ...
    short: "C4GT",
    description: "India's mentorship program for digital public goods. Contributors build on health, education, welfare, and commerce platforms that run at population scale.",
    fullDescription: "Code for GovTech (C4GT) runs a dedicated mentoring program where students contribute to the digital public goods behind Indian governance platforms. Projects are published by organizations maintaining systems such as Beckn, Sunbird, OpenG2P, Avni, and Bahmni. Selected contributors get a stipend, a maintainer as mentor, and a certificate.",
    eligibility: "Students and early career developers, primarily in India",
    eligibilityType: "Open to All",
    stipend: "Stipend for selected contributors",
    stipendPaid: true,
    stipendRange: "Medium",
    window: "Apr – Jun (applications)",
    status: "Annual",
    region: "India",
    website: "https://www.codeforgovtech.in",
    applyUrl: "https://www.codeforgovtech.in",
    color: "text-stone-700",
    bgColor: "bg-stone-50 border-stone-200",
    tags: ["india", "govtech", "digital-public-goods", "mentorship"],
    requirements: [
      "Comfort with Git, GitHub, and reading an unfamiliar codebase",
      "Working knowledge of the project's stack (often Java, Python, or React)",
      "A submitted proposal against a published project ticket",
      "Prior contribution to the project is strongly favoured",
      "Around 20 hours a week through the mentoring period",
      "Willingness to work with real deployment and data constraints",
    ],
    timeline: [
      { phase: "Project & Ticket Publication", dates: "Mar – Apr" },
      { phase: "Contributor Applications", dates: "Apr – Jun" },
      { phase: "Mentor Interviews & Selection", dates: "June" },
      { phase: "Mentoring Period", dates: "Jun – Sep" },
      { phase: "Mid-term Evaluation", dates: "August" },
      { phase: "Final Demo & Certification", dates: "September" },
    ],
    howToApply: [
      "Browse published tickets on codeforgovtech.in",
      "Join the C4GT Discord and the project's own community channel",
      "Set up the project locally and close a starter issue",
      "Discuss your approach with the ticket's mentor",
      "Submit a proposal covering scope, milestones, and deployment impact",
      "Attend the interview and keep contributing while results are decided",
    ],
    applicationDeadline: nextDate(5, 31),
    difficulty: "Intermediate",
    focusArea: "DEVELOPMENT",
  },
  {
    ...
    short: "OSPP",
    description: "Summer program run by the Institute of Software, Chinese Academy of Sciences. Communities publish funded tasks and students worldwide apply with a proposal.",
    fullDescription: "The Open Source Promotion Plan (OSPP) is organised annually by ISCAS. Communities such as openEuler, KubeEdge, OpenHarmony, Apache projects, and RT-Thread publish tasks at a basic or advanced funding tier. Students submit a proposal, and accepted students code from July to September with a community mentor.",
    eligibility: "Students worldwide, no nationality restriction",
    eligibilityType: "Students",
    stipend: "RMB 8,000 – 12,000 (by task tier)",
    stipendPaid: true,
    stipendRange: "Medium",
    window: "Apr – Jun (applications)",
    status: "Annual",
    ...
    applyUrl: "https://summer-ospp.ac.cn",
    color: "text-stone-700",
    bgColor: "bg-stone-50 border-stone-200",
    tags: ["global", "cloud-native", "paid", "mentorship"],
    requirements: [
      "Registered student at the time of application, 18 or older",
      "Proposal submitted against a task published by a community",
      "Language skills matching the task (Go, C, C++, Java, or Rust)",
      "Student identity verification and a signed agreement if selected",
      "Communication with the mentor in English or Chinese",
      "Completion of mid-term and final deliverables to be paid",
    ],
    timeline: [
      { phase: "Community & Task Publication", dates: "Apr – May" },
      { phase: "Student Registration & Proposals", dates: "May – Jun" },
      { phase: "Proposal Review & Matching", dates: "June" },
      { phase: "Coding Period", dates: "Jul – Sep" },
      { phase: "Mid-term Evaluation", dates: "August" },
      { phase: "Final Review & Payment", dates: "Oct – Nov" },
    ],
    howToApply: [
      "Browse published tasks by community on summer-ospp.ac.cn",
      "Contact the task mentor and confirm scope before writing anything",
      "Build the project and land a small patch to show competence",
      "Register as a student and upload identity documents",
      "Submit a proposal with a week-by-week plan for the coding period",
      "Track review results and sign the agreement if selected",
    ],
    applicationDeadline: nextDate(6, 4),
    difficulty: "Intermediate",
    focusArea: "DEVELOPMENT",
  },
  {
    id: 24,
    slug: "igalia-coding-experience",
    name: "Igalia Coding Experience",
    short: "Igalia CE",
    description: "Paid, part-time grant where students work with Igalia engineers on browsers, GPU drivers, multimedia frameworks, and language runtimes.",
    fullDescription: "The Igalia Coding Experience gives students a first professional contact with open source consultancy work. Grantees are mentored by Igalia engineers and spend a reduced number of hours per week on Chromium, WebKit, Mesa, GStreamer, or compiler work. Terms run for several months and can be extended, and the work lands upstream in real projects.",
    eligibility: "Students and people early in their career, with priority for under-represented groups",
    eligibilityType: "Open to All",
    stipend: "Paid grant, part-time hours",
    stipendPaid: true,
    stipendRange: "Medium",
    window: "Sep – Oct (applications)",
    status: "Annual",
    region: "Global (remote)",
    website: "https://www.igalia.com/coding-experience/",
    applyUrl: "https://www.igalia.com/coding-experience/",
    color: "text-stone-700",
    bgColor: "bg-stone-50 border-stone-200",
    tags: ["browsers", "graphics", "cpp", "paid", "remote"],
    requirements: [
      "Solid C++ or C, depending on the team you apply to",
      "Ability to build a large codebase such as Chromium, WebKit, or Mesa",
      "Comfort with code review, bug trackers, and upstream patch workflow",
      "Availability for part-time hours over several months",
      "A short statement on which team and topic interest you",
      "Some prior contribution to any open source project helps",
    ],
    timeline: [
      { phase: "Positions Announced", dates: "Sep – Oct" },
      { phase: "Applications & CV Review", dates: "October" },
      { phase: "Technical Conversations", dates: "Oct – Nov" },
      { phase: "Grant Term Starts", dates: "Dec – Jan" },
      { phase: "Mentored Part-time Work", dates: "Several months" },
      { phase: "Report & Possible Extension", dates: "End of term" },
    ],
    howToApply: [
      "Read the open positions listed on igalia.com/coding-experience",
      "Pick the team whose stack you can realistically build and debug",
      "Compile the project locally and study a few recent commits",
      "Land a small upstream patch if the timeline allows it",
      "Send a CV plus a statement naming the team and your motivation",
      "Prepare for a technical conversation with an Igalia engineer",
    ],
    applicationDeadline: nextDate(10, 15),
    difficulty: "Advanced",
    focusArea: "DEVELOPMENT",
  }
];
...
const BROWSER_ROUTES: Record<string, string> = {
  ...
  "Summer of Bitcoin": "/student/opensource/summer-of-bitcoin",
  "GirlScript Summer of Code": "/student/opensource/gssoc",
  "Code for GovTech": "/student/opensource/c4gt",
  "Open Source Promotion Plan": "/student/opensource/ospp",
  "KDE Season of Kode": "/student/opensource/season-of-kde",
  "Igalia Coding Experience": "/student/opensource/igalia",
};
