    ...
    <div className="bg-stone-50 dark:bg-stone-950 min-h-[calc(100vh-4rem)]">
      <SEO
        ...
        structuredData={[
          ...
          faqSchema([
            {
              question: "Is this CSS course free?",
              answer:
                "Yes, the CSS course on InternHack is completely free with no sign-up required.",
            },
            {
              question: "What will I learn in this CSS course?",
              answer:
                "You will learn selectors, box model, flexbox, CSS grid, animations, and responsive design from beginner to advanced.",
            },
            {
              question: "Do I need to know HTML before learning CSS?",
              answer:
                "Basic HTML knowledge is recommended before starting the CSS course.",
            },
          ]),
        ]}
      />
          ...
          <div className="flex items-end justify-between gap-4 flex-wrap">
            <div className="min-w-0">
              ...
              <p className="text-sm text-stone-600 dark:text-stone-400 max-w-2xl">
                Interactive CSS lessons, curated for interviews. Box model,
