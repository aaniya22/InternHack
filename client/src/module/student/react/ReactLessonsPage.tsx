    ...
    <div className="bg-stone-50 dark:bg-stone-950 min-h-[calc(100vh-4rem)]">
      <SEO
        ...
        structuredData={[
          ...
          faqSchema([
            {
              question: "Is this React course free?",
              answer:
                "Yes, the React course on InternHack is completely free with no sign-up required.",
            },
            {
              question: "What do I need to know before learning React?",
              answer:
                "You should be comfortable with JavaScript, especially ES6+ features like arrow functions, destructuring, and modules.",
            },
            {
              question: "What will I build in this React course?",
              answer:
                "You will build real-world projects using components, hooks, and state management patterns.",
            },
          ]),
        ]}
      />
          ...
          <div className="flex items-end justify-between gap-4 flex-wrap">
            <div className="min-w-0">
              ...
              <p className="text-sm text-stone-600 dark:text-stone-400 max-w-2xl">
                Interactive React lessons, curated for interviews. Components,
                hooks, state, and routing.
              </p>
            </div>
