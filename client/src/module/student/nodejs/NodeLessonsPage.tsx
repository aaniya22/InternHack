    ...
    <div className="bg-stone-50 dark:bg-stone-950 min-h-[calc(100vh-4rem)]">
      <SEO
        ...
        structuredData={[
          ...
          faqSchema([
            {
              question: "Is this Node.js course free?",
              answer:
                "Yes, the Node.js course on InternHack is completely free with no sign-up required.",
            },
            {
              question: "What will I learn in this Node.js course?",
              answer:
                "You will learn server-side JavaScript, npm, the Express framework, REST APIs, and connecting to databases.",
            },
            {
              question: "Do I need to know JavaScript before learning Node.js?",
              answer:
                "Yes, solid JavaScript knowledge is required before starting the Node.js course.",
            },
          ]),
        ]}
      />
          ...
          <div className="flex items-end justify-between gap-4 flex-wrap">
            <div className="min-w-0">
              ...
              <p className="text-sm text-stone-600 dark:text-stone-400 max-w-2xl">
                Interactive Node.js lessons, curated for interviews. Event loop,
