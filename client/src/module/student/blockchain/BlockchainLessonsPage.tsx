    ...
    <div className="bg-stone-50 dark:bg-stone-950 min-h-[calc(100vh-4rem)]">
      <SEO
        ...
        structuredData={[
          ...
          faqSchema([
            {
              question: "Is this Blockchain course free?",
              answer:
                "Yes, the Blockchain course on InternHack is completely free with no sign-up required.",
            },
            {
              question: "What will I learn in this Blockchain course?",
              answer:
                "You will learn blockchain fundamentals, smart contracts, decentralized applications, and Web3 development concepts.",
            },
            {
              question: "Do I need programming knowledge for Blockchain?",
              answer:
                "Basic programming knowledge is helpful, though the course starts from blockchain fundamentals.",
            },
          ]),
        ]}
      />
          ...
          <div className="flex items-end justify-between gap-4 flex-wrap">
            <div className="min-w-0">
              ...
              <p className="text-sm text-stone-600 dark:text-stone-400 max-w-2xl">
                Interactive blockchain lessons, curated for interviews. Smart
                contracts, Solidity, DApps, and DeFi.
              </p>
            </div>
